...
resultado := BBvsSB_ORx3_3H(posx, posy, mesa, x1, y1, x2, y2, alto, ancho, x1t, y1t, altot, anchot, p2name, p2stack, p2bet, p2btn, p3name, p3stack, p3bet, p3btn, stackefect, p1bet, p1btn, mano, p2, p3, save_img_mesa, p2manos_3h, p2vip_3h, p2pfr_3h, p2_3bet_3h, p3vip_3h, p3pfr_3h, p3_3bet_3h, p2_manos_hu_db, p2_vip_hu, p2_pfr_hu, p2_bet_3_hu, p3_manos_hu_db, p3_vip_hu, p3_pfr_hu, p3_bet_3_hu)

BBvsSB_ORx3_3H(posx, posy, mesa, x1, y1, x2, y2, alto, ancho, x1t, y1t, altot, anchot, p2name, p2stack, p2bet, p2btn, p3name, p3stack, p3bet, p3btn, stackefect, p1bet, p1btn, mano, p2, p3, save_img_mesa, p2manos_3h, p2vip_3h, p2pfr_3h, p2_3bet_3h, p3vip_3h, p3pfr_3h, p3_3bet_3h, p2_manos_hu_db, p2_vip_hu, p2_pfr_hu, p2_bet_3_hu, p3_manos_hu_db, p3_vip_hu, p3_pfr_hu, p3_bet_3_hu)
{
	...
	if(p2btn = 0 && p2bet = "" && p1bet = 1  && p3bet = 3)
	{
		...
		situacionglobal := "BBvsSB_ORx3_3H"
		;MsgBox, %p3%
		if(p3 == "fish" && p3bet < (0.5*stackefect))
		{
			BBvsSB_FISH(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
		}
		else if(p3 == "reg" && p3bet < (0.5*stackefect))
		{
			BBvsSB_REG(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
		}
...
BBvsSB_FISH(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
{
	...
	;MsgBox, estamos en la funcion BBvsSB_AI_REG
	situacion := "vs SB 3H ORx3 fish"
	if (stackvalue >= 0 && stackvalue < 8)
    {
        if (situacionfinal = "BBvsSB_FISH_ORX3_3H 6 BB")
        {
            return
        }
        situacionfinal := "BBvsSB_FISH_ORX3_3H 6 BB"
    ...
    {
        if (situacionfinal = "BBvsSB_FISH_ORX3_3H 8 BB")
        {
            return
        }
        situacionfinal := "BBvsSB_FISH_ORX3_3H 8 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
        poscionclick("F2P4", x1t, y1t, anchot, altot)
    }
	else if (stackvalue >= 11 && stackvalue < 12.5)
    {
        if (situacionfinal = "BBvsSB_FISH_ORX3_3H 11 BB")
        {
            return
        }
        situacionfinal := "BBvsSB_FISH_ORX3_3H 11 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
        poscionclick("F2P4", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "BBvsSB_FISH_ORX3_3H 15 BB")
        {
            return
        }
        situacionfinal := "BBvsSB_FISH_ORX3_3H 15 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
        poscionclick("F2P4", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "BBvsSB_FISH_ORX3_3H +18 BB")
        {
            return
        }
        situacionfinal := "BBvsSB_FISH_ORX3_3H +18 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
...
BBvsSB_REG(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
{
    ...
    {
        if (situacionfinal = "BBvsSB_ORx3_REG_21_BB")
        {
            return
        }
        situacionfinal := "BBvsSB_ORx3_REG_21_BB"
    ...
    {
        if (situacionfinal = "BBvsSB_ORx3_REG_25_BB")
        {
            return
        }
        situacionfinal := "BBvsSB_ORx3_REG_25_BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
