...
resultado := SBvsBB_3H(posx, posy, mesa, x1, y1, x2, y2, alto, ancho, x1t, y1t, altot, anchot, p2name, p2stack, p2bet, p2btn, p3name, p3stack, p3bet, p3btn, stackefect, p1bet, p1btn, mano, p2, p3, save_img_mesa,p2manos_3h,p3manos_3h, p2vip_3h, p2pfr_3h, p2_3bet_3h, p3vip_3h, p3pfr_3h, p3_3bet_3h, p2_manos_hu_db, p2_vip_hu, p2_pfr_hu, p2_bet_3_hu, p3_manos_hu_db, p3_vip_hu, p3_pfr_hu, p3_bet_3_hu)

SBvsBB_3H(posx, posy, mesa, x1, y1, x2, y2, alto, ancho, x1t, y1t, altot, anchot, p2name, p2stack, p2bet, p2btn, p3name, p3stack, p3bet, p3btn, stackefect, p1bet, p1btn, mano, p2, p3, save_img_mesa,p2manos_3h,p3manos_3h, p2vip_3h, p2pfr_3h, p2_3bet_3h, p3vip_3h, p3pfr_3h, p3_3bet_3h, p2_manos_hu_db, p2_vip_hu, p2_pfr_hu, p2_bet_3_hu, p3_manos_hu_db, p3_vip_hu, p3_pfr_hu, p3_bet_3_hu)
{


    ;MsgBox, %p3stack%  %p3bet%
	if(p3stack > 0 && p3bet = "")
	{
           ...
           if(p1bet = 0.5)
            {
                ...
                if(p2 = "fish")
                {
                    ...
                    situacion := "SB 3H vs FISH"

                    vsfish(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)

                }
                if(p2 = "reg")
                {
                    situacion := "SB 3H vs REG"
                    vsreg(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
                }
    ...
    if(p3btn = 0 && p1bet = 1 && p2bet > p1bet)
    {
		
	    ;MsgBox, nos enfretamos a un rol
        situacionglobal := "SBvsBB_3HvsROL"
    ...
    if(p3btn = 0 && p1bet > 1 && p2bet > p1bet)
    {
        ...
        ;MsgBox, nos enfretamos a un rol
        situacionglobal := "SBvsBB_3Hvs3bet"
...
vsfish(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
{
    if (stackvalue < 6)
    {
        ...
        if (situacionfinal = "SB 3H vs FISH nash")
        {
            return
        }

        situacionfinal := "SB 3H vs FISH nash"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P6", x1t, y1t, anchot, altot)
    }
    else if (stackvalue >= 6 && stackvalue < 8)
    {
        if (situacionfinal = "SB 3H vs FISH 6-8 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs FISH 6-8 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "SB 3H vs FISH 8-11 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs FISH 8-11 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "SB 3H vs FISH 11-14 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs FISH 11-14 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "SB 3H vs FISH 14-18 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs FISH 14-18 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "SB 3H vs FISH +18 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs FISH +18 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
...
vsreg(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
{
    if (stackvalue < 9)
    {
        ...
        ;resultado := CheckInRange(valormanos, stackvalue)
        ;MsgBox, %resultado%
        ...
        if (situacionfinal = "SB 3H vs REG  NASH")
        {
            return
        }

        situacionfinal := "SB 3H vs REG  NASH"
    ...
    {
        if (situacionfinal = "SB 3H vs REG 9 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 9 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "SB 3H vs REG 10 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 10 BB"
        ;MsgBox, entramos en el 8
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "SB 3H vs REG 11 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 11 BB"
        ;MsgBox, entramos en el 9
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P6", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "SB 3H vs REG 13 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 13 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P5", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "SB 3H vs REG 15 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 15 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P4", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "SB 3H vs REG 17 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 17 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P3", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "SB 3H vs REG 21 BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 21 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P2", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "SB 3H vs REG 25+ BB")
        {
            return
        }

        situacionfinal := "SB 3H vs REG 25+ BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O64", x1t, y1t, anchot, altot)
        poscionclick("F1P1", x1t, y1t, anchot, altot)
    }
