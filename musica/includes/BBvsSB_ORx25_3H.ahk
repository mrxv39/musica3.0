...
resultado := BBvsSB_ORx25_3H(posx, posy, mesa, x1, y1, x2, y2, alto, ancho, x1t, y1t, altot, anchot, p2name, p2stack, p2bet, p2btn, p3name, p3stack, p3bet, p3btn, stackefect, p1bet, p1btn, mano, p2, p3, save_img_mesa, p2manos_3h, p2vip_3h, p2pfr_3h, p2_3bet_3h, p3vip_3h, p3pfr_3h, p3_3bet_3h, p2_manos_hu_db, p2_vip_hu, p2_pfr_hu, p2_bet_3_hu, p3_manos_hu_db, p3_vip_hu, p3_pfr_hu, p3_bet_3_hu)

BBvsSB_ORx25_3H(posx, posy, mesa, x1, y1, x2, y2, alto, ancho, x1t, y1t, altot, anchot, p2name, p2stack, p2bet, p2btn, p3name, p3stack, p3bet, p3btn, stackefect, p1bet, p1btn, mano, p2, p3, save_img_mesa, p2manos_3h, p2vip_3h, p2pfr_3h, p2_3bet_3h, p3vip_3h, p3pfr_3h, p3_3bet_3h, p2_manos_hu_db, p2_vip_hu, p2_pfr_hu, p2_bet_3_hu, p3_manos_hu_db, p3_vip_hu, p3_pfr_hu, p3_bet_3_hu)
{
	...
	if(p2btn = 0 && p2bet = "")
	{
		...
		if(p1bet = 1)
		{
			...
			if(p3bet > 2 && p3bet <= 2.5 && p3bet < (0.5*stackefect) && p3stack > 0)
			{
				...
				situacionglobal := "BBvsSB_ORx2.5_3H"
			
				if(p3 == "fish")
				{
            
					BBvsSB_FISH25(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
				}
				else if(p3 == "reg")
				{
					BBvsSB_REG25(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
				}
...
BBvsSB_FISH25(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
{
    if (stackvalue < 6)
    {
        if (situacionfinal = "BB 3H vs 2.5 FISH < 6 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs 2.5 FISH < 6 BB"
    ...
    {
        if (situacionfinal = "BB 3H vs 2.5 FISH 6-8 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs 2.5 FISH 6-8 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
        poscionclick("F1P5", x1t, y1t, anchot, altot)
    }
    ...
    {
        if (situacionfinal = "BB 3H vs 2.5 FISH 8-11 BB")
        {
            return
        }
        situacionfinal := "BB HU 3H 2.5 FISH 8-11 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "BB 3H vs 2.5 FISH 11-14 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs 2.5 FISH 11-14 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "BB 3H vs 2.5 FISH 14-18 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs 2.5 FISH 14-18 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
    ...
    {
        if (situacionfinal = "BB 3H vs 2.5 FISH +18 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs 2.5 FISH +18 BB"
        poscionclick("IIIPLA", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
...
BBvsSB_REG25(posx, posy, manos, stackvalue, mesa, x1t, y1t, anchot, altot)
{
	...
	if (stackvalue >= 0 && stackvalue < 14)
    {
        if (situacionfinal = "BB 3H vs REG x2.5  13 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs REG x2.5  13 BB"
    ...
    {
        if (situacionfinal = "BB 3H vs REG x2.5  15 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs REG x2.5  15 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
        poscionclick("F2P4", x1t, y1t, anchot, altot)
    }
    else if (stackvalue >= 16 && stackvalue < 18)
    {
        if (situacionfinal = "3H HU vs REG x2.5 17 BB")
        {
            return
        }
        situacionfinal := "3H HU vs REG x2.5 17 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
        poscionclick("F2P3", x1t, y1t, anchot, altot)
    }
    else if (stackvalue >= 18 && stackvalue < 23)
    {
        if (situacionfinal = "BB 3H vs REG x2.5  19 BB")
        {
            return
        }
        situacionfinal := "BB 3H vs REG x2.5  19 BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
    ...
    else if (stackvalue >= 23 && stackvalue < 1000)
    {
        ...
        if (situacionfinal = "BB 3H vs REG x2.5 25+ BB")
        {
            return
        }
        situacionfinal := "BB 3H vs REG x2.5 25+ BB"
        poscionclick("IIIMU", x1t, y1t, anchot, altot)
        poscionclick("O65", x1t, y1t, anchot, altot)
